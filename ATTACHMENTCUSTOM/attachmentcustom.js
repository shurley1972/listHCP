...
define(['text!./attachmentcustom.html'], function( htmlString) {
	function Attachmentcustom( params) { //attachmentPrefix, attachmentFileName, absoluteFileUrl) {
		var self = this;
		self.params = params;
...
debugger;				
	...
	Attachmentcustom.prototype.schema = {
		"Params": {
			"prefix": "",
			"required": false
		}
...
//debugger;			
    ...
    return { viewModel: Attachmentcustom, template: htmlString };
});
